...
{
  Product* books = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
  return books;
}
...
{
  Product* cloth = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
  return cloth;
}
...
{
  Product* movies = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
  return movies;
}
