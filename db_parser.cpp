...
Review* DBParser::parseReview(istream& is, string prodname)
{
  ...
  if(error_){
    ...
    return makeReview(prodname, rating, rater, date, review_text);
  }

}

Review* DBParser::makeReview(string& prodname, int& rating, string& rater, string& date, string& review_text)
{
  return new Review(prodname, rating, rater, date, review_text);
}
